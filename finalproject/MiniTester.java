...
class MyHashTableADV<K, V> extends MyHashTable<K, V>{
    ...
    public MyHashTableADV(int c) {super(c);}
...
class Part1Test {
    ...
    public void getValueSet2() {
        ...
        received.sort(Comparator.naturalOrder());
        for (int i = 0; i < 8; i++) assertEquals((char) ('A'+i), received.get(i));
    }
    ...
    public void getEntries1() {
        MyHashTableADV<Integer, String> h = new MyHashTableADV<Integer, String>(10);
        List<MyPair<Integer, String>> expected = List.of(new MyPair<Integer, String>(3, "Hello"), new MyPair<Integer, String>(9, "World"),
                new MyPair<Integer, String>(15, "Goodbye"), new MyPair<Integer, String>(21, "World"));
        for (MyPair<Integer, String> p: expected) h.setEle(p);
    ...
    public void getEntries2() {
        ...
        List<MyPair<Integer, String>> expected = List.of(new MyPair<Integer, String>(1, "A"), new MyPair<Integer, String>(2, "B"),
                new MyPair<Integer, String>(3, "C"), new MyPair<Integer, String>(4, "D"), new MyPair<Integer, String>(13, "E"),
                new MyPair<Integer, String>(14, "F"), new MyPair<Integer, String>(15, "G"), new MyPair<Integer, String>(16, "H"));
    ...
    public void Iterator1() {
        MyHashTableADV<Integer, String> h = new MyHashTableADV<Integer, String>(10);
        ArrayList<MyPair<Integer, String>> expected = new ArrayList<>(List.of(new MyPair<Integer, String>(3, "Hello"), new MyPair<Integer, String>(9, "World"),
                new MyPair<Integer, String>(15, "Goodbye"), new MyPair<Integer, String>(21, "World")));
        for (MyPair<Integer, String> p: expected) h.setEle(p);
    ...
    public void Iterator2() {
        ...
        ArrayList<MyPair<Integer, String>> expected = new ArrayList<>(List.of(new MyPair<Integer, String>(1, "A"), new MyPair<Integer, String>(2, "B"),
                new MyPair<Integer, String>(3, "C"), new MyPair<Integer, String>(4, "D"), new MyPair<Integer, String>(13, "E"),
                new MyPair<Integer, String>(14, "F"), new MyPair<Integer, String>(15, "G"), new MyPair<Integer, String>(16, "H")));
...
class Part2Test {
    ...
    public void RatingDistributionByProfessorTest() {
        ...
        assertEquals(dist.get("1"), 1);
        assertEquals(dist.get("2"), 0);
        assertEquals(dist.get("3"), 1);
        assertEquals(dist.get("4"), 0);
        assertEquals(dist.get("5"), 2);
    }
    ...
    public void RatingDistributionBySchoolTest() {
        ...
        MyHashTable<String, Integer> dist = ratingDistributionBySchool.getDistByKeyword("pennsylvania college of technology");
        String key1 = "amber  donahue" + "\n" + "3.63";
        String key2 = "david  burke" + "\n" + "4.33";
        assertEquals(dist.get(key1), 8);
        assertEquals(dist.get(key2), 6);
    }
    ...
    public void GenderByKeyword() {
        ...
        assertEquals(dist.get("F"), 461);
        assertEquals(dist.get("X"), 7);
        assertEquals(dist.get("M"), 424);
    }
    ...
    public void RatingByKeyword() {
        ...
        assertEquals(dist.get("1"), 167);
        assertEquals(dist.get("2"), 40);
        assertEquals(dist.get("3"), 21);
        assertEquals(dist.get("4"), 10);
        assertEquals(dist.get("5"), 14);
    }
    ...
    public void RatingByGender() {
        ...
        assertEquals(dist.get("1"), 1916);
        assertEquals(dist.get("2"), 2022);
        assertEquals(dist.get("3"), 2441);
        assertEquals(dist.get("4"), 1817);
        assertEquals(dist.get("5"), 1260);
    }
}